...
*/
public class Position_Model_Vertex_LineSegment_ver1
{
   public static void main(String[] args)
   {
      final Scene scene = new Scene("Position_Model_Vertex_LineSegment_ver1");
      ...
      model_0.addPrimitive(new LineSegment(0, 1),  // square
                           new LineSegment(1, 2),
                           new LineSegment(2, 3),
                           new LineSegment(3, 0));

      model_1.addPrimitive(new LineSegment(3, 2),  // Z
                           new LineSegment(2, 0),
                           new LineSegment(0, 1));

      model_2.addPrimitive(new LineSegment(0, 2),  // X
                           new LineSegment(1, 3));

      model_3.addPrimitive(new LineSegment(0, 1),
                           new LineSegment(1, 2),
                           new LineSegment(3, 0),
                           new LineSegment(0, 2),
                           new LineSegment(1, 3));
      ...
      fb.dumpFB2File("Position_Model_Vertex_LineSegment_ver1.ppm");

      // Draw pictures of the scene's tree data structure.
      DrawSceneGraph.drawVertexList = true;
      DrawSceneGraph.draw(scene, "Position_Model_Vertex_LineSegment_ver1_SG");
   }
}
