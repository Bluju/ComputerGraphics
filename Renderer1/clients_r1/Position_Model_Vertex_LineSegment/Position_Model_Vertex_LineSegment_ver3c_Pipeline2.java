...
/**
   Use this program to analyze all
   three pipeline stages.
<p>
   This version draws the X shape as in
   version 3a.
<p>
...
*/
public class Position_Model_Vertex_LineSegment_ver3c_Pipeline2
{
   public static void main(String[] args)
   {
      final Scene scene = new Scene("Position_Model_Vertex_LineSegment_ver3a");
      ...
      final LineSegment ls0  = new LineSegment(0, 1),  // front edges
                        ls1  = new LineSegment(1, 2),
                        ls2  = new LineSegment(2, 3),
                        ls3  = new LineSegment(3, 0),
                        ls4  = new LineSegment(0, 2),  // front diagonals
                        ls5  = new LineSegment(1, 3),
                        ls6  = new LineSegment(4, 5),  // back edges
                        ls7  = new LineSegment(5, 6),
                        ls8  = new LineSegment(6, 7),
                        ls9  = new LineSegment(7, 4),
                        ls10 = new LineSegment(4, 6),  // back diagonals
                        ls11 = new LineSegment(5, 7),
                        ls12 = new LineSegment(0, 4),  // front to back edges
                        ls13 = new LineSegment(1, 5),
                        ls14 = new LineSegment(2, 6),
                        ls15 = new LineSegment(3, 7),
                        ls16 = new LineSegment(0, 5),  // bottom diagonals
                        ls17 = new LineSegment(1, 4),
                        ls18 = new LineSegment(3, 6),  // top diagonals
                        ls19 = new LineSegment(2, 7),
                        ls20 = new LineSegment(0, 7),  // left side diagonals
                        ls21 = new LineSegment(3, 4),
                        ls22 = new LineSegment(1, 6),  // right side diagonals
                        ls23 = new LineSegment(2, 5),
                        ls24 = new LineSegment(0, 6),  // interior diagonals
                        ls25 = new LineSegment(1, 7),
                        ls26 = new LineSegment(2, 4),
                        ls27 = new LineSegment(3, 5);
...
//                         ls5, ls11, ls13, ls15, ls25, ls27);
      ...
      fb.dumpFB2File("Position_Model_Vertex_LineSegment_ver3c_Pipeline2.ppm");
      ...
      DrawSceneGraph.draw(scene,
         "Position_Model_Vertex_LineSegment_ver3c_Pipeline2_SG");
      DrawSceneGraph.draw(Pipeline2.scene1,
         "Position_Model_Vertex_LineSegment_ver3c_Pipeline2_stage1_SG");
      DrawSceneGraph.draw(Pipeline2.scene2,
         "Position_Model_Vertex_LineSegment_ver3c_Pipeline2_stage2_SG");
      DrawSceneGraph.draw(Pipeline2.scene3,
         "Position_Model_Vertex_LineSegment_ver3c_Pipeline2_stage3_SG");
   }
}
