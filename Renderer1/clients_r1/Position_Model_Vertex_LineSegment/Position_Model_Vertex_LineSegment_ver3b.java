...
<p>
   The only difference between versions 3b
   and 3a is in how the X shape is drawn.
<p>
...
*/
public class Position_Model_Vertex_LineSegment_ver3b
{
   public static void main(String[] args)
   {
      final Scene scene = new Scene("Position_Model_Vertex_LineSegment_ver3b");
...
//                         ls2, ls6, ls21, ls23, ls26, ls27);
      ...
      fb.dumpFB2File("Position_Model_Vertex_LineSegment_ver3b.ppm");

      // Draw a picture of the scene's tree data structure.
      DrawSceneGraph.drawVertexList = true;
      DrawSceneGraph.draw(scene, "Position_Model_Vertex_LineSegment_ver3b_SG");
   }
}
