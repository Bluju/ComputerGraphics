...
*/
public class Position_Model_Vertex_LineSegment_ver2a_Pipeline2
{
   public static void main(String[] args)
   {
      ...
      fb.dumpFB2File("Position_Model_Vertex_LineSegment_ver2a_Pipeline2.ppm");
      ...
      DrawSceneGraph.draw(scene,
         "Position_Model_Vertex_LineSegment_ver2a_Pipeline2_SG");
      DrawSceneGraph.draw(Pipeline2.scene1,
         "Position_Model_Vertex_LineSegment_ver2a_Pipeline2_stage1_SG");
      DrawSceneGraph.draw(Pipeline2.scene2,
         "Position_Model_Vertex_LineSegment_ver2a_Pipeline2_stage2_SG");
      DrawSceneGraph.draw(Pipeline2.scene3,
         "Position_Model_Vertex_LineSegment_ver2a_Pipeline2_stage3_SG");
   }
}
