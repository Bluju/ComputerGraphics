...
*/
public class Position_Model_Vertex_LineSegment_ver2_Model2Camera
{
   public static void main(String[] args)
   {
      ...
      fb.dumpFB2File("Position_Model_Vertex_LineSegment_ver2_Model2Camera.ppm");

      // Draw pictures of the scene's tree data structure.
      DrawSceneGraph.drawVertexList = true;
      DrawSceneGraph.draw(scene, "Position_Model_Vertex_LineSegment_ver2_Model2Camera_SG");
   }
}
