...
<p>
   The only difference between versions 3a
   and 3b is in how the X shape is drawn.
<p>
...
*/
public class Position_Model_Vertex_LineSegment_ver3a
{
...
//                         ls5, ls11, ls13, ls15, ls25, ls27);
      ...
      fb.dumpFB2File("Position_Model_Vertex_LineSegment_ver3a.ppm");

      // Draw a picture of the scene's tree data structure.
      DrawSceneGraph.drawVertexList = true;
      DrawSceneGraph.draw(scene, "Position_Model_Vertex_LineSegment_ver3a_SG");
   }
}
