...
*/
public class ThreeDimensionalScene_R1
{
   public static void main(String[] args)
   {
      // Create the Scene object that we shall render.
      final Scene scene = new Scene("ThreeDimensionalScene_R1");
      ...
      DrawSceneGraph.draw(scene, "ThreeDimensionalScene_R1_SG");
      DrawSceneGraph.drawVectorDetails = true;
      DrawSceneGraph.draw(scene, "ThreeDimensionalScene_R1_SG_with_Vectors");
      DrawSceneGraph.drawVertexList = true;
      DrawSceneGraph.draw(scene, "ThreeDimensionalScene_R1_SG_with_Vertices");
      ...
      fb.dumpFB2File("ThreeDimensionalScene_R1.ppm");
   }
}
