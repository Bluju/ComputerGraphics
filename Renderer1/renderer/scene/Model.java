...
/**
   ...
   of {@link Vertex} objects and another {@link List} of {@link Primitive}
   objects.
<p>
...
<p>
   ...
   two vertices are the endpoints of the line segment.
<p>
   Each {@link Point} object contains one integer index of a {@link Vertex}
   from the {@code Model}'s vertex list.
<p>
